...
import net.chaossquad.mclib.commands.TasksSubcommand;
...
public class GameTasksSubcommand implements TabCompletingCommandExecutor {
    @NotNull private final Bedwars plugin;

    public GameTasksSubcommand(@NotNull Bedwars plugin) {
        this.plugin = plugin;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        return TasksSubcommand.onCommand(game.getTaskScheduler(), sender, args);
    }
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        return TasksSubcommand.onTabComplete(game.getTaskScheduler(), sender, args);
    }
