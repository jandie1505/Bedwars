...
import net.jandie1505.bedwars.game.lobby.commands.players.LobbyPlayersAddSubcommand;
...
public class LobbyPlayersSubcommand extends SubcommandCommand {
    ...
    public LobbyPlayersSubcommand(@NotNull Lobby lobby) {
        ...
        this.addSubcommand("add", SubcommandEntry.of(new LobbyPlayersAddSubcommand(lobby)));
    }
