...
public class LobbyPlayersRemoveSubcommand implements TabCompletingCommandExecutor {
    @NotNull private final Lobby lobby;

    public LobbyPlayersRemoveSubcommand(@NotNull Lobby lobby) {
        this.lobby = lobby;
    }
    ...
    public boolean onCommand(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        boolean ingameBefore = this.lobby.isPlayerIngame(playerId);
    ...
    public @Nullable List<String> onTabComplete(@NotNull CommandSender sender, @NotNull Command command, @NotNull String label, @NotNull String @NotNull [] args) {
        ...
        if (args.length == 1) return this.lobby.getRegisteredPlayers().stream()
                .map(uuid -> {
